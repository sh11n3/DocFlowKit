...
public:
    ...
    bool mergePdfPages(const QStringList& pageSpecs, const QString& outputFile, QString& errorMessage);

    bool runOcrOnPdf(const QString& inputFile, const QString& outputFile, QString& errorMessage);
};